...
#slide(title: "MOAS Analysis")[
  ...
  FROM routes
  WHERE cardinality(origin_asn) = 1
...
#let slide_box(content) = box(height: 13.5em, align(top, content))

#slide(title: "MOAS Analysis: Evaluation", slide_box[
  - #stress[Alle #moas_4 IPv4-Präfixe wurden mit zmap gescannt]
])

#slide(title: "MOAS Analysis: Evaluation", slide_box[
  - Alle #moas_4 IPv4-Präfixe wurden mit zmap gescannt
...
#slide(title: "MOAS Analysis: Beispiel", slide_box[
  ...
  - #stress[zmap-Scan ergibt, dass ein TLS-Dienst auf der Adresse `41.221.216.10` erreichbar ist]
])
...
#slide(title: "MOAS Analysis: Beispiel", slide_box[
  ...
  - AS 31713: "Gateway Communications"
  - AS 3491: "PCCW Global (HK) Ltd."
  - zmap-Scan ergibt, dass ein TLS-Dienst auf der Adresse `41.221.216.10` erreichbar ist
