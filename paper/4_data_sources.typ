...
_Shodan_ ist eine Datenbank, die Informationen über öffentlich erreichbare Geräte im Internet sammelt.
...
Es gibt außerdem keine offizielle Angabe darüber, wie viele Geräte und Dienste tatsächlich in der Datenbank erfasst sind.
...
_Probes_ sind Netzwerkgeräte, die, ähnlich wie _Vantage Points_, von Freiwilligen betrieben werden.
_RIPE Atlas_ erlaubt es Nutzenden beliebige _Probes_ für Messungen, wie z.B. Pings und DNS-Anfragen, an Dritte zu verwenden.

_RIPE Atlas_ hat 14.469 aktive _Probes_ in 183 verschiedenen Ländern (Stand: Januar 2026). @ripe-atlas-stats
